...
# ❗ 原本是 'RL.sumocfg'，但你沒有這個檔案
# ❗ 改成用程式所在資料夾裡的 Traci.sumocfg（請確認檔名真s的叫這個）
...
def get_state():  # 3.& 4. Constraint 3 & 4
    ...
    # Detector IDs for Node2-4-SB
    detector_Node2_4_SB_0 = "Node2_4_SB_0"
    detector_Node2_4_SB_1 = "Node2_4_SB_1"
    detector_Node2_4_SB_2 = "Node2_4_SB_2"
    ...
    q_SB_0 = get_queue_length(detector_Node2_4_SB_0)
    q_SB_1 = get_queue_length(detector_Node2_4_SB_1)
    q_SB_2 = get_queue_length(detector_Node2_4_SB_2)
...
for step in range(TOTAL_STEPS):
    ...
    # Record data every step（你原本寫 %1，其實就是每一個 step）
    if step % 1 == 0:
